...
%* SAS Management Console 9.4 lets you create an IdentityGroup (group/role) object in a custom
   repository, but will not let you create one in a project repository. We therefore look for
   IdentityGroup objects in both foundation and custom repositories.
