...
%* SAS Management Console 9.4 will not let you create a Person (user) object in a custom or a
   project repository, so we do not look for Phone objects in non-foundation repositories.
...
put '      <PATH syntax="XPath">/GetMetadataObjects/Objects/Phone/Persons/Person/@Name</PATH>';
put '      <TYPE>character</TYPE>';
put '      <DATATYPE>string</DATATYPE>';
put '      <LENGTH>240</LENGTH>';
put '    </COLUMN>';
