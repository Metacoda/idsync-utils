...
Sample: metacodaIdentityGroupExtractSample.sas

Purpose:
   Demonstrates the use of the metacodaIdentityGroupExtract macro.
...
%include '../sasautos/metacodaidentitygroupextract.sas';
...
* Sample 1: extract basic attributes for all IdentityGroup objects;

%metacodaIdentityGroupExtract(table=work.idGroups);

* -----------------------------------------------------------------------------;

* Sample 2: extract basic attributes for all IdentityGroup objects as above
...
title1 "IdentityGroup objects";

proc contents data=work.idGroups;
run;

proc print data=work.idGroups label width=min;
run;
